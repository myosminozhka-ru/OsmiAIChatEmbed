...
export type MessageTypeKind = 'apiMessage' | 'userMessage' | 'usermessagewaiting' | 'leadCaptureMessage';
...
/** @deprecated Use ObserversConfigType */
export type observersConfigType = ObserversConfigType;
export {};
